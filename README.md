This paper is primarily authored by Andrew Hobden (@hoverbear) and Yvonne Coady (@ycoady) and it's purpose is to introduce Operating Systems instructors to an alternative language.
